...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func buildMainMenu() {
        ...
        // ── oFinder ─────────────────────────────────────────────────────────
        let appMenu = submenu("oFinder")
        appMenu.addItem(withTitle: L10n.t("menu.about", "About oFinder"),
        ...
        appMenu.addItem(.separator())
        appMenu.addItem(withTitle: L10n.t("menu.hide", "Hide oFinder"),
        ...
        appMenu.addItem(.separator())
        appMenu.addItem(withTitle: L10n.t("menu.quit", "Quit oFinder"),
        ...
        // Also the mouse thumb buttons: drivers that remap them to keystrokes
        // send these two rather than a raw button, so both routes need to work.
        viewMenu.addItem(withTitle: L10n.t("toolbar.back", "Back"),
                         action: #selector(FinderWindowController.goBack(_:)),
                         keyEquivalent: "[")
        viewMenu.addItem(withTitle: L10n.t("toolbar.forward", "Forward"),
                         action: #selector(FinderWindowController.goForward(_:)),
                         keyEquivalent: "]")
